...
python src/run_simulation.py --lsf --slurm --wg-insertion-loss 0 --dc-insertion-loss 0 --num-resonators 1 --reciprocal -1 --frequency-sweep --components "r::phase:-6.28318530718:6.28318530718:64" "r::coupling:0:1:64"
python src/run_simulation.py --lsf --slurm --wg-insertion-loss 0 --dc-insertion-loss 0 --num-resonators 1 --reciprocal 0 --frequency-sweep --components "r::phase:-6.28318530718:6.28318530718:64" "r::coupling:0:1:64"
